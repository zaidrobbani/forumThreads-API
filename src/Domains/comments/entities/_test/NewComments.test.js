...
describe('NewComments Entities', () => {
    it('should throw when payload not contain needed property', () => {
        ...
        // Action and Assert
        expect(() => new NewComments(payload)).toThrow('NEW_COMMENTS.NOT_CONTAIN_NEEDED_PROPERTY');
    });
    ...
    it('should throw when payload not meet data type specification', () => {
        ...
        // Action and Assert
        expect(() => new NewComments(payload)).toThrow('NEW_COMMENTS.NOT_MEET_DATA_TYPE_SPECIFICATION');
    });
