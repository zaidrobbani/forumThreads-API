import NewAuthentications from "../NewAuthentications.js";
...
describe("NewAuthentications entities", () => {
  it("should throw error when payload did not contain needed property", () => {
    ...
    // Action and Assert
    expect(() => new NewAuthentications(payload)).toThrow(
      "NEW_AUTHENTICATIONS.NOT_CONTAIN_NEEDED_PROPERTY"
    );
  });
  ...
  it("should throw error when payload not meet data type specification", () => {
    ...
    // Action and Assert
    expect(() => new NewAuthentications(payload)).toThrow(
      "NEW_AUTHENTICATIONS.NOT_MEET_DATA_TYPE_SPECIFICATION"
    );
  });
